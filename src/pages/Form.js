  ...
  return (
    <>
      <form>
        <FormStyled>
          <h1>
            Schreibe Deinem Garten – <br />
            ein paar nette Karten:
          </h1>
          <p>Motivation:</p>
          <input
            maxLength="38"
            ...
            onChange={e =>
              setFormValue({ ...formValue, motivation: e.target.value })
            }
          />
          ...
          <input
            ...
            onChange={e =>
              setFormValue({ ...formValue, aufgabe: e.target.value })
            }
          />
